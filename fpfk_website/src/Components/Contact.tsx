            ...
            <div className="space-y-8">
              <div className="bg-white rounded-lg shadow-xl p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600">Kawangware 46, Nairobi, Kenya</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="h-6 w-6 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span className="text-gray-600">+254 720 952 345</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="h-6 w-6 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span className="text-gray-600">fpfk@gmail.com</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-xl p-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600"><span className="font-semibold">Thursday:</span> 6:00 PM - 7:00 PM</p>
                  <p className="text-gray-600"><span className="font-semibold">Saturday:</span> 6:00 PM - 7:00 PM</p>
                </div>
              </div>
            </div>
          </div>
